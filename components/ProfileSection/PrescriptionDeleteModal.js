...
const PrescriptionDeleteModal = ({
  prescriptionModalDelete,
  setPrescriptionModalDelete,
  deleteId,
  setDeleteId,
  handleDelete,
}) => {
  ...
  return (
    <Transition appear show={prescriptionModalDelete} as={Fragment}>
      <Dialog
        as="div"
                  ...
                  <div className="bg-gray-100 my-5">
                    <div>
                      <p className="text-center font-semibold tracking-wider font-body text-lg text-black">
                        Do you want to delete this prescription file?
                      </p>
                    </div>
                    ...
                    <div className="flex space-x-5 justify-center mt-6">
                      ...
                      <div onClick={() => handleDelete(deleteId)}>
                        <button className="bg-red-600 text-white font-medium tracking-wider px-5 py-2 rounded-lg font-body text-sm">
                          Delete
                        </button>
                      </div>
                    </div>
