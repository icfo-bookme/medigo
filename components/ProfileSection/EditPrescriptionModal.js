...
const EditPrescriptionModal = ({
  EditPrescriptionModalOpen,
  setEditPrescriptionModalOpen,
  item,
  updateID,
  setUpdateID,
  setItem,
  ...
  useEffect(() => {
    if (selectedFile) {
      ...
      reader.onload = () => {
        const base64Data = reader.result; // Get the Base64 data part
  ...
  return (
    <Transition appear show={EditPrescriptionModalOpen} as={Fragment}>
      <Dialog
        as="div"
                ...
                <div className="py-4 bg-gray-100 flex flex-col justify-center">
                  ...
                  <div className="bg-gray-100 my-5">
                    <div>
                      ...
                      >
                        <input {...getInputProps()} />
                        {!selectedFile && Object.keys(item)?.length !== 0 ? (
                          <Image
